local variants = require("themes.substrata.colors")
local cfg = require("themes.substrata.config").config
local c = variants[cfg.variant]
local utils = require("themes.substrata.utils")
local M = {}
...
local set_groups = function()
  local groups = {
    ...
    Title = { fg = c.red, bg = c.none, style = "bold" },
    ...
    variable = { fg = c.pink },                                            -- a number constant: 5
